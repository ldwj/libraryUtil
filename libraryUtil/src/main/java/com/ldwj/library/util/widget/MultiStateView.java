 ...
 *  *
 ...
 app:msv_emptyView="@layout/multistateview_empty"
 app:msv_errorView="@layout/multistateview_error"
 app:msv_loadingView="@layout/multistateview_loading"
 app:msv_viewState="loading" >
 //contentView
 <view />
 </MultiStateView>
 //Java代码 通过设置状态展示不同的view
